<?php 
    ...
    if ($direccion >= -45 && $direccion <= 45) {
		$left  =  \GeometryLibrary\SphericalUtil::computeOffset(['lat' => $origen['lat'], 'lng' => $origen['lng']], 40, $direccion -45);
		$right =  \GeometryLibrary\SphericalUtil::computeOffset(['lat' => $origen['lat'], 'lng' => $origen['lng']], 40, $direccion +45);
